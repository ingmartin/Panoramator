...
* опциональный `photo-mode` для кропа плоской панорамы до полностью видимого прямоугольника без внутренних чёрных клиньев;
...
* `photo_mode` - включает более агрессивный crop до максимального прямоугольника, целиком лежащего в видимой области плоской панорамы. Для цилиндрической и сферической проекции безопасно применяется обычный crop по внешней границе: строгий прямоугольник там может отбросить большую часть изображения. По умолчанию `False`.
...
Если нужен итоговый кадр без любых чёрных углов после плоского warp, включите `photo-mode`:
